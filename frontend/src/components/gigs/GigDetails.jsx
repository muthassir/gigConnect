...
//   try {
//     setError("");
//     const response = await startConversation(receiverId, gig._id);
...
//           <button 
//   onClick={() => startConversation(gig.client._id)}
...
import { useParams, Link, useNavigate } from "react-router-dom";
import { useAuth } from "../../context/AuthContext";
import { fetchGig, applyToGig, startConversation } from "../../services/api";
import Alert from "../Alert";
